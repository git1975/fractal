...
public class Renderer {
    ...
    public void doRender(RenderArea area) {
        // Log.d("RenderThread.doRender", "area|" + area.toString());
        int i = 0;
        int j = 0;

        // Буфер для хранения скоростей убегания
        ...
        // Если граница квадрата одного цвета, то внутри все того-же цвета
